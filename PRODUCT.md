...
## Brand & tone
- **Voix** : experte mais accessible, concrète, orientée ROI / gain de temps, rassurante, **humaine et chaleureuse**. Deuxième personne (« vous »). Phrases claires et courtes.
- **Univers visuel** : chaleureux et éditorial, proche de l'esthétique **Claude / Anthropic** (crème, terracotta, encre, serif éditorial). L'humain et la pédagogie au centre, pas la machine.
...
- Le **« look tech froid »** : bleu nuit SaaS générique, néon, dark techy, dégradés violets « IA ».
- Le **jargon IA** (LLM, RAG, embeddings…) en façade.
- Le **template SaaS cliché** : hero-metric (gros chiffre + stats), grilles de cartes identiques icône+titre+texte à l'infini.
- L'**agence IA générique** interchangeable. On veut une identité chaude, éditoriale, spécialisée formation.
