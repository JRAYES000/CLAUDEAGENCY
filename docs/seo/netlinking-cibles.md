# Netlinking — Cibles prêtes à exécuter

> Document **prêt-à-exécuter** pour une session locale (navigateur) qui ira soumettre / contacter.
...
## 0. Rappel de phase (cf. NETLINKING.md §3 & §7)

Domaine **neuf, 0 backlink** → on est en **phase Fondation (Mois 1-3)** :
- **Priorité = liens fondateurs gratuits** (annuaires sérieux, profils, GBP, LinkedIn) + premières mentions gagnées.
- **Ancres : ~100% marque / URL nue les 30 premiers jours.** 0% exact-match externe (voir §4).
- L'achat de liens (RocketLinks/Semjuice…) est **hors périmètre de ce document** : il n'intervient qu'au T2, balisé `sponsored`. Ne pas démarrer par là.
...
## 1. Tableau de cibles priorisées

> Légende type : **annuaire** · **fédération** · **guest post** · **PR** (presse / digital PR) · **profil** (propriété de marque).
> Priorité **haute** = pertinence forte + accessible en phase Fondation. **moyenne** = à faire après le socle, ou effort/incertitude plus élevés.
> « à vérifier » = URL exacte ou modalité non confirmée — à valider dans le navigateur avant action.

| # | Cible | Type | URL de soumission / contact | Pertinence thématique | Priorité | Note (coût / dofollow probable) |
|---|-------|------|------------------------------|------------------------|----------|---------------------------------|
...
| 7 | **Les Acteurs de la Compétence** (ex-FFP) | fédération | https://www.lesacteursdelacompetence.fr — rubrique « Adhérer » / contact (domaine exact **à vérifier** : l'ancien `ffp.org` redirige) | Fédération nationale des organismes de formation privés | **haute** | Adhésion **payante** (cotisation). Annuaire des adhérents = lien thématique fort. Dofollow à vérifier. |
| 8 | **FFFOD** (Forum des acteurs de la formation digitale) | fédération | https://www.fffod.org — adhésion / annuaire membres | Formation digitale + innovation pédagogique → très aligné IA | **haute** | Adhésion payante (assoc.). Annuaire membres. Dofollow à vérifier. |
| 9 | **Sourcee** (HARO français) | PR | https://www.sourcee.fr — inscription comme expert / source | Demandes de journalistes FR, dont formation / IA / RH | **haute** | Gratuit (freemium). Liens éditoriaux gagnés (presse). Founder-led, Julien répond. |
| 10 | **Annuaire de la formation — Centre Inffo / data** | annuaire | Référencement OF via Mon Activité Formation / déclaration NDA déjà faite ; vérifier visibilité annuaire | Annuaire officiel des OF | moyenne | Gratuit. Citation institutionnelle. Lien site à vérifier. |
| 11 | **Annuaire d'organismes de formation thématique** (ex. trouvermaformation, lesopco, annuaires régionaux d'OF) | annuaire | Soumission au cas par cas (**URLs à vérifier**) | Annuaires sectoriels formation | moyenne | Souvent gratuit. **Filtrer** : éviter les annuaires-fermes sans trafic (NETLINKING §1.3). Garder ceux qui ont un vrai trafic. |
| 12 | **OPCO (site de l'OPCO de rattachement)** | fédération / ressource | Selon branche — ex. annuaire prestataires référencés (**OPCO à confirmer selon activité**) | Financeurs de la formation, écosystème direct | moyenne | Gratuit si référencé comme prestataire. Lien à vérifier. |
| 13 | **Focus RH** `[DA 55 ✓]` | guest post / PR | https://www.focusrh.com — rubrique « Tribunes » / contact rédaction | RH / L&D — élargissement pertinent (NETLINKING §6.9) | **haute** | Tribune gratuite si éditoriale (gagnée). Publie déjà des tribunes signées → dofollow probable. |
| 14 | **Le Blog du Modérateur (BDM)** | PR / guest post | https://www.blogdumoderateur.com — proposer sujet IA/outils via contact | Numérique / outils / IA appliquée (grand public pro) | moyenne | Éditorial gagné, très sélectif. Fort DA. Pitcher le Baromètre comme actu data. |
| 15 | **Cadre & Dirigeant Magazine / Courrier Cadres** | guest post / PR | Contact rédaction (**URL à vérifier**) | Dirigeants, management, transfo digitale | moyenne | Tribune / interview gagnée. Dofollow à vérifier. |
| 16 | **Blogs EdTech FR** (ex. Thot Cursus, blogs spécialisés digital learning) | guest post | Thot Cursus : https://cursus.edu — proposer article ; autres **à vérifier** | EdTech / pédagogie numérique = cœur thématique | **haute** | Article invité gagné. Thot Cursus accepte contributions. Dofollow à vérifier. |
| 17 | **Communautés / blogs Qualiopi** (consultants, certificateurs partenaires) | guest post / partenariat | Repérage manuel (**cibles à identifier**) | Qualiopi = entité centrale du cluster | **haute** | Co-contenu non transactionnel (NETLINKING §5 Tier 1). Échange d'expertise, pas d'achat. |
| 18 | **Réseaux régionaux d'OF / Carif-Oref régional** | fédération / annuaire | Carif-Oref de la région (réseau des Carif-Oref — rdc-formation, **URL régionale à vérifier**) | Réseau régional officiel formation-emploi | moyenne | Gratuit. Référencement OF régional. Lien à vérifier. |
...
## 2. Descriptif de fiche réutilisable (3 longueurs)

> Ton conforme à PRODUCT.md : expert mais accessible, concret, orienté gain de temps, zéro jargon IA. FR. « vous ».
> À coller dans les champs « description » des annuaires / profils.

**Version 50 caractères** (titres / champs courts) :
> Conseil en IA pour organismes de formation.
...
## 3. E-mails d'outreach (variables entre crochets)

> Codes culturels FR (NETLINKING §6) : relation et crédibilité d'abord, pas de cold email transactionnel. Signer au nom de Julien.
...
### B. Proposition d'article invité

> Objet : Proposition de tribune — l'IA au service des organismes de formation
...
- « [Titre 1 — ex. Comment l'IA fait gagner 5 h/semaine à un organisme de formation] »
- « [Titre 2 — ex. Qualiopi et IA : automatiser la preuve sans tricher] »

L'article serait original, sans jargon, orienté cas concrets — pas un publi-rédactionnel. Je peux vous envoyer un plan détaillé si le principe vous intéresse.
...
### C. Pitch presse / Centre Inffo — le « Baromètre IA des OF »

> Objet : Étude inédite — où en sont vraiment les organismes de formation avec l'IA ?

Bonjour [Prénom / la rédaction de [média]],

Je me permets de vous contacter car nous menons la **première enquête chiffrée et indépendante sur l'adoption de l'IA dans les organismes de formation français** : le *Baromètre de l'IA dans les organismes de formation*.

L'objectif : rendre visible la réalité du secteur — usages réels, temps gagné, freins, projets 2026 — sur la base des réponses des OF eux-mêmes, pas d'un discours marketing.
...
- **Liens gagnés majoritaires** : viser une majorité de liens éditoriaux/fondateurs vs achetés (un profil 100% acheté paraît artificiel).
- **Registre CSV** : consigner chaque action (domaine, DA, trafic réel, ancre, URL cible, type, payant ou non, balisage `rel`, date).
