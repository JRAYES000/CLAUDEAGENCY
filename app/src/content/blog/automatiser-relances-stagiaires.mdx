---
title: "Automatiser les relances stagiaires : les 4 moments clés"
description: "Relances stagiaires : les quatre moments où elles évitent un no-show, comment les automatiser avec Make, et comment mesurer ce que ça rapporte."
pubDate: 2026-06-30
author: "Julien Rayes"
image: "./images/automatiser-relances-stagiaires-cover.webp"
imageAlt: "Automatisation des relances stagiaires pour organisme de formation"
tags: ["automatisation", "relances", "stagiaires", "Make", "email", "organisme de formation"]
draft: false
---

Les relances d'un organisme de formation s'automatisent presque entièrement, et trois scénarios couvrent l'essentiel : les rappels avant la session, la collecte des évaluations après, et le rattrapage des absents. Ils se montent dans Make sans écrire une ligne de code. C'est là que se récupèrent les heures perdues chaque semaine — et une partie du no-show qu'on croit inévitable.
...
| **Twilio / Brevo SMS** | Envoi SMS | ~0,07€/SMS |
...
- **[Automatisation des process](/services/automatisation/)** — mettre en place ces relances automatiques chez vous, de bout en bout.
