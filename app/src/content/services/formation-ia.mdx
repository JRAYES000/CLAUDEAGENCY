...
faq:
  ...
  - { q: "Les formations sont-elles finançables ?", a: "Non. Claude Agency est un prestataire de services, pas un organisme de formation : nos ateliers ne sont imputables ni sur le CPF, ni sur un budget OPCO, ni sur une aide France Travail. Ils se règlent sur fonds propres et passent en charge d'exploitation déductible." }
relatedTags: ["IA"]
---
...
métier](/blog/chatgpt-formateurs/). Cette montée en compétence se prolonge
