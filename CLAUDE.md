...
- **Publier directement en production** (merge sur `main`) dès que le travail est prêt et que
  le build est vérifié, sans attendre de validation : Julien veut voir les pages en ligne.
  Signaler clairement après coup ce qui a été publié, avec les URLs.
